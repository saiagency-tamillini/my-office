...
@section('content')
    <div class="container">
        ...
        @if($sales->isNotEmpty())
            ...
            <button type="button" class="btn btn-secondary mb-3" id="calcBalanceBtnSalesReport" data-balance-calc-toggle aria-pressed="false">Calculate Total</button>
        @endif
        ...
        <form method="POST" action="{{ route('bulk-sale-update') }}">
            ...
            <div id="printArea">
                ...
                @endif
                <table class="table table-bordered" data-balance-calc="sales_report">
                    <thead>
                        <tr>
                            <th>S.No</th>
...
@push('scripts')
    <script>
        window.__balanceCalc_sales_report = {
            toggleButton: '#calcBalanceBtnSalesReport',
